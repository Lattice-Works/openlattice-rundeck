...
from openlattice-rundeck.exceptions import (  # noqa: F401
    ApiTypeError,
    ApiValueError
)
...
class ProjectApi(object):
    ...
    def project_create(self, project_create_request, **kwargs):  # noqa: E501
        """Create a new project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.project_create(project_create_request, async_req=True)
        >>> result = thread.get()

        :param project_create_request: (required)
        :type project_create_request: object
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.project_create_with_http_info(project_create_request, **kwargs)  # noqa: E501

    def project_create_with_http_info(self, project_create_request, **kwargs):  # noqa: E501
        """Create a new project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.project_create_with_http_info(project_create_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('project_create_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['project_create_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `project_create_request` when calling `project_create`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'project_create_request' in local_var_params:
            path_params['ProjectCreateRequest'] = local_var_params['project_create_request']  # noqa: E501
