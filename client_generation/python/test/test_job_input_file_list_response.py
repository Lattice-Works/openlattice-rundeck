...
import olrundeck
from olrundeck.models.job_input_file_list_response import JobInputFileListResponse  # noqa: E501
...
class TestJobInputFileListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = olrundeck.models.job_input_file_list_response.JobInputFileListResponse()  # noqa: E501
        if include_optional :
            return JobInputFileListResponse(
                paging = olrundeck.models.paging.Paging(
                    ...
                    max = 56, ), 
                files = [
                    olrundeck.models.job_input_file_info.JobInputFileInfo(
                        id = '0', 
                        user = '0', 
                        file_state = 'temp', 
                        sha = '0', 
