...
class AclPolicyResponse(object):
    ...
    @property
    def contents(self):
        """Gets the contents of this AclPolicyResponse.  # noqa: E501

        Policy as JSON encoded YAML string  # noqa: E501

        :return: The contents of this AclPolicyResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def contents(self, contents):
        """Sets the contents of this AclPolicyResponse.

        Policy as JSON encoded YAML string  # noqa: E501

        :param contents: The contents of this AclPolicyResponse.  # noqa: E501
        :type contents: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AclPolicyResponse):
            return False
