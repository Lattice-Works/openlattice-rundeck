...
import openlattice_rundeck.models
from openlattice_rundeck import rest
from openlattice_rundeck.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(openlattice_rundeck.models, klass)
