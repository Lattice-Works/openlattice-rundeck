...
with olrundeck.ApiClient(configuration) as api_client:
    ...
    api_instance = olrundeck.JobApi(api_client)
...
# **job_get**
> object job_get(id, format=format)
...
format = None # object |  (optional)
    ...
    try:
        # Export a single job definition in XML or YAML formats.
        api_response = api_instance.job_get(id, format=format)
        pprint(api_response)
    except ApiException as e:
...
with olrundeck.ApiClient(configuration) as api_client:
    ...
    try:
        # Get metadata about a specific job.
        api_response = api_instance.job_info_get(id)
        pprint(api_response)
    except ApiException as e:
...
with olrundeck.ApiClient(configuration) as api_client:
    ...
    try:
        # Get job input file info
        api_response = api_instance.job_input_file_info_get(id)
        pprint(api_response)
    except ApiException as e:
...
with olrundeck.ApiClient(configuration) as api_client:
    ...
    try:
        # List uploaded input files for job
        api_response = api_instance.job_input_files_upload(id)
        pprint(api_response)
    except ApiException as e:
...
# **job_list**
> list[Job] job_list(project, id_list=id_list, group_path=group_path, job_filter=job_filter, job_exact_filter=job_exact_filter, group_path_exact=group_path_exact, scheduled_filter=scheduled_filter, server_node_uuid_filter=server_node_uuid_filter)
...
server_node_uuid_filter = 'server_node_uuid_filter_example' # str | In cluster mode, use to select scheduled jobs assigned to the server with the given UUID. (optional)
    ...
    try:
        # List the jobs that exist for a project
        api_response = api_instance.job_list(project, id_list=id_list, group_path=group_path, job_filter=job_filter, job_exact_filter=job_exact_filter, group_path_exact=group_path_exact, scheduled_filter=scheduled_filter, server_node_uuid_filter=server_node_uuid_filter)
        pprint(api_response)
    except ApiException as e:
...
with olrundeck.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = olrundeck.JobApi(api_client)
    inline_object5 = olrundeck.InlineObject5() # InlineObject5 | 
...
with olrundeck.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = olrundeck.JobApi(api_client)
    inline_object4 = olrundeck.InlineObject4() # InlineObject4 | 
...
with olrundeck.ApiClient(configuration) as api_client:
    ...
    try:
        # Get job workflow tree.
        api_response = api_instance.job_workflow_get(id)
        pprint(api_response)
    except ApiException as e:
