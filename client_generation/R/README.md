# R API client for openlattice_rundeck
...
cd GIT_REPO_ID
R CMD build .
R CMD check openlattice_rundeck_0.1.0.tar.gz
R CMD INSTALL openlattice_rundeck_0.1.0.tar.gz
```

### Install the package

```R
install.packages("openlattice_rundeck")
```
